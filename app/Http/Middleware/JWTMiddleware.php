...
class JWTMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response {
        try {
            ...
            return response()->json(['status' => 'Token is Invalid : 토큰이 유효하지 않습니다. 만료된 토큰 사용 중'], 401);
            ...
            try {
                ...
                return response()->json([
                    'msg' => 'Token cannot be refreshed, Try login again : 토큰을 새로 고칠 수 없습니다. refresh기간 만료, 다시 로그인해 보세요.',
